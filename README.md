...
Optimized full screen mod links from Snokido. This is useful if you don't want to download a popular mod from Gamebanana and have it take up space. If you click the three dots on the top right corner of your browser, go to more tools, then click Add Shortcut, it will be like you actually downloaded the mod. This will get updated when a new FNF mod gets added to Snokido. The gamaverse links aren't that useful since it doesn't display the actual mod icon.
...
https://fnf.run3.io/shaggy-matt/1.5/
